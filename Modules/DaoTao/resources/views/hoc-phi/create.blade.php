            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" name="hoc_phi_mot_hk" class="form-control" value="{{ old('hoc_phi_mot_hk') }}" min="0">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Học phí/Tín chỉ (đồng) <span class="text-danger">*</span></label>
                        <input type="number" name="hoc_phi_tin_chi" class="form-control" value="{{ old('hoc_phi_tin_chi') }}" min="0">
                    </div>
                </div>
            </div>
            <div class="form-group">
